...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    if ($name == "" || $email == "" || $category == "" || $title == "") {
        $error_message = "Please fill in the required fields: <br> Name, Email and Category and Title";
    }
    ...
    if (!isset($error_message)) {
        ...
        $mail->addAddress('p.trindade@wkmedia.pt', 'Pedro Trindade');     // Add a recipient
        $mail->isHTML(false);                                  // Set email format to HTML

        $mail->Subject = 'Treehouse PHP FORM Test -' . $name;
    ...
    <div class="section page">
        <div class="wrapper">
            ...
            <?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
                echo "<p>Thanks for the email ! I'll check your submission shortly.</p>";
            } else { ?>
                ...
                <form method="post" action="suggest.php">
                    <?php
                        if (isset($error_message)) {
                            ...
                            echo "<p>If you think something I'm missing, let me know! Complete the form to send me an email.</p>";
                        }
                    ?>
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name="details" id="details" placeholder="Insert Text Here"><?php if(isset($details)){ echo $details; } ?></textarea></td>
                        </tr>
                        <tr style="display:none">
                            <th><label for="address">Address</label></th>
                            <td><input type="text" name="address" id="address">
                                <p>Please leave field blank</p>
                            </td>
                        </tr>
                    </table>
